...
pnAdvancerLeft.addEventListener("click", function() {
    ...
    if (determineOverflow(scrollableTabsNavContents, scrollableTabsNav) === "left" || determineOverflow(scrollableTabsNavContents, scrollableTabsNav) === "both") {
...
pnAdvancerRight.addEventListener("click", function() {
    ...
    if (determineOverflow(scrollableTabsNavContents, scrollableTabsNav) === "right" || determineOverflow(scrollableTabsNavContents, scrollableTabsNav) === "both") {
